...
public class SelButton extends Button {
    ...
    public SelButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SelButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onDraw(Canvas canvas) {
        if (isNeedSelected()&&isSelected()) {
            getBackground().setColorFilter(selectorFilter);
        } else {
