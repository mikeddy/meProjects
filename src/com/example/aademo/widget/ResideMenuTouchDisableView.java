 ...
 */
class ResideMenuTouchDisableView extends ViewGroup {
    ...
    public ResideMenuTouchDisableView(Context context) {
        this(context, null);
    }

    public ResideMenuTouchDisableView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
